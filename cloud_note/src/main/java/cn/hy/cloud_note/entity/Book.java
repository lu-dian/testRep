package cn.hy.cloud_note.entity;
...
public class Book implements Serializable{
	...
	public String toString() {
		return "NoteBook [cn_user_id=" + cn_user_id + ", cn_notebook_id=" + cn_notebook_id + ", cn_notebook_name="
				+ cn_notebook_name + ", cn_notebook_type_id=" + cn_notebook_type_id + ", cn_notebook_desc="
